...
/** `matches: false` → dar ekran → alt sayfa; `true` → masaüstü paneli. */
...
describe('Combobox otomatik odak', () => {
  ...
  /*
   * Masaustunde ekran klavyesi YOK; oradaki odak yazarak aramanin ve ok
   * tuslariyla gezinmenin tek dayanagi.
   */
