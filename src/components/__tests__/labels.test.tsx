...
/**
 * Kütüphane hiçbir dilde metin uydurmaz — ama aynı "Kapat" dizesini yüz çağrı
 * yerine dağıtmak da doğru değildi. Çözümleme sırası bu dosyanın konusu:
 * <strong>prop → sağlayıcı config'i → geliştirme uyarısı.</strong>
 */
describe('metin çözümlemesi', () => {
  ...
  /*
   * Gostergenin ZATEN adi olan bir ogenin icinde durdugu yerlerde (yukleniyor
   * durumundaki bir dugme) duyurmak tekrar uretiyor. Bos dize orada dogru olan
   * ve config'i de bastirmali.
   */
  ...
  /*
   * Derleyici sagayicinin varligini goremiyor; bu yuzden eksik metin bir tip
   * hatasi degil, calisma zamani uyarisi. Uyari OLMAZSA hata sessiz kaliyor:
   * `aria-label`i olmayan kapatma dugmesi ekran okuyucuda "dugme" diye okunur
   * ve ekranda hicbir iz birakmaz.
   */
...
describe('config’in eriştiği bileşenler', () => {
  ...
  /* Deger metnin ICINE giriyor: config bir dize degil bicimlendirici tutar. */
