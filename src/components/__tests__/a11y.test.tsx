 ...
 * `console.error` uretiyor. Tarama sirasinda o gurultu gercek bir hatayi
 * gizlerdi; ustelik metinsiz bir kapatma dugmesi ekran okuyucuda ADSIZ kalir ve
 * axe onu zaten ihlal olarak bildirir — yani saglayicisiz tarama BASKA bir
 * seyi olcerdi.
 */
...
describe('eksen taraması', () => {
  it.each(cases)('%s — %s', async (_component, _state, element) => {
    ...
    /*
     * `document.body` taranir, `container` degil: `BottomSheet` portal ile
     * govdeye tasiniyor ve kapsayici taransaydi kipsel panellerin TAMAMI
     * denetimin disinda kalirdi — hem de tam olarak odak ve ad sozlesmesinin
     * en kirilgan oldugu yerde.
     */
