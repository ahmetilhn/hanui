import { matchesSearch, normalizeSearchTerm } from '../text.helper';
...
describe('normalizeSearchTerm', () => {
  ...
  /*
   * `toLowerCase()` "İSTANBUL"u birlesik noktali `i̇stanbul` yapiyor ve
   * eslesme kaciyordu; `İ → i` esleme kucultmeden ONCE yapilmak zorunda.
   */
